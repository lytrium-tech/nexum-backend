...
class Goal(Base):
    ...
    monthly_required: Mapped[Decimal | None] = mapped_column(Numeric, nullable=True)
    daily_required: Mapped[Decimal | None] = mapped_column(Numeric, nullable=True)
    progress_percentage: Mapped[Decimal | None] = mapped_column(Numeric, nullable=True)
